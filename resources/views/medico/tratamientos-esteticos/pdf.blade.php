...
<style>
/* ── PALETA ──
   #795300  dorado oscuro  → acento primario
   #e5d4b8  arena cálida   → bordes, dividers
   #fffcf7  blanco crema   → fondo header / footer
   #f6f1eb  beige suave    → fondo body / card heads
   #ffffff  blanco puro    → superficies de cards
*/
...
.firma-img-wrap { height:52px; text-align:center; margin-bottom:4px; }
...
.firma-ok     { display:inline-block; background:rgba(121,83,0,.07); border:1px solid rgba(121,83,0,.2); border-radius:4px; padding:3px 8px; color:#795300; font-size:8px; font-weight:bold; margin-top:3px; }
...
@if($config?->logo)
<div class="watermark">
  <img src="{{ storage_path('app/public/'.$config->logo) }}" style="width:360px;">
</div>
@endif
...
<div class="header">
  <div class="header-inner">
    ...
    <div class="header-right">
      @if($config?->logo)
        <div style="margin-bottom:8px;"><img src="{{ storage_path('app/public/'.$config->logo) }}" style="max-height:36px;"></div>
      @elseif($tratamiento->medico?->logo)
        <div style="margin-bottom:8px;"><img src="{{ storage_path('app/public/'.$tratamiento->medico->logo) }}" style="max-height:36px;"></div>
      @endif
...
<div class="body">
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Datos del Paciente</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="g2">
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot" style="background:#b42828;"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Antecedentes Médicos</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="g2">
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Evaluación Clínica y Estética</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="g2">
        <div class="g2-l">
          ...
          <div style="margin-bottom:10px;">
            @foreach($tiposPiel as $tp)
              <span class="tag-item {{ in_array($tp,$selTipos)?'tag-on':'tag-off' }}">{{ $tp }}</span>
            @endforeach
          </div>
          ...
          <div style="margin-bottom:10px;">
            @foreach($condList as $c)
              <span class="tag-item {{ in_array($c,$selCond)?'tag-on':'tag-off' }}">{{ $c }}</span>
            @endforeach
          </div>
          ...
          <div class="g2">
            ...
            <div class="g2-l" style="padding-right:10px;">
              ...
              <div class="cb-table">
                <div class="cb-icon-cell"><div class="cb-box {{ $tratamiento->simetria===$s?'cb-box-on':'' }}">{{ $tratamiento->simetria===$s?'✓':'' }}</div></div>
                <div class="cb-txt-cell">{{ $s }}</div>
              </div>
              @endforeach
            </div>
            @endif
            ...
            <div class="g2-r">
              ...
              <div class="cb-table">
                <div class="cb-icon-cell"><div class="cb-box {{ $tratamiento->tonicidad===$t?'cb-box-on':'' }}">{{ $tratamiento->tonicidad===$t?'✓':'' }}</div></div>
                <div class="cb-txt-cell">{{ $t }}</div>
              </div>
              @endforeach
            </div>
            @endif
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot" style="background:#c4a97a;"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Signos Vitales</div></div>
      </div>
    </div>
    <div class="card-body">
      @php
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Exploración Física</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="obs-box">{{ $tratamiento->exploracion_fisica }}</div>
    </div>
  </div>
  @endif
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Distribución de Zonas y Dosificación</div></div>
      </div>
    </div>
    <div class="card-body">
      @php
      ...
      <div class="mapa-layout">
        <div class="mapa-col">
          <img src="{{ $mapaBase64 }}" width="178" height="240" style="display:block;"/>
          <div style="font-size:7.5px;color:#c4a97a;text-align:center;margin-top:3px;">
            <span style="color:#795300;">&#9679;</span> Zona predefinida &nbsp;
            <span style="color:#b42828;">&#9679;</span> Punto libre
          </div>
        </div>
        <div class="tabla-col">
          ...
          <table class="dosis-tbl" style="margin-bottom:8px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="color:#8a7355;font-size:8.5px;">{{ $zona->notas ?? '' }}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
          ...
          <table class="dosis-tbl" style="margin-bottom:8px;">
            <thead>
              ...
              <tr style="background:#a07a30;"><th>Nombre / Zona</th><th style="text-align:center;">Cantidad</th><th>Etiqueta</th></tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td style="font-size:8px;color:#8a7355;">{{ $pl->notas ?? '' }}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
          @endif
          <table class="dosis-tbl">
            <tbody>
              <tr><td class="td-total" colspan="2" style="font-size:11px;">TOTAL APLICADO</td><td class="td-total" style="text-align:center;font-size:14px;">{{ $totalUnidades }} U</td></tr>
            </tbody>
          </table>
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Zonas a Aplicar</div></div>
      </div>
    </div>
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot" style="background:#c4a97a;"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Producto Utilizado</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="g3">
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-head-inner">
        <div class="ch-dot-cell"><div class="ch-dot"></div></div>
        <div class="ch-title-cell"><div class="ch-title">Notas Clínicas</div></div>
      </div>
    </div>
    <div class="card-body">
      <div class="g2">
        @if($tratamiento->observaciones_generales)
        <div class="g2-l"><div class="lbl" style="margin-bottom:4px;">Observaciones generales</div><div class="obs-box">{{ $tratamiento->observaciones_generales }}</div></div>
        @endif
        @if($tratamiento->observaciones_post)
        <div class="g2-r"><div class="lbl" style="margin-bottom:4px;">Observaciones post-aplicación</div><div class="obs-box">{{ $tratamiento->observaciones_post }}</div></div>
        @endif
      </div>
    </div>
  </div>

...
<div class="page">
  ...
  <div class="content">
    ...
    @php
      $zonaLabelsMap = [
        'F'=>'Frente','GL'=>'Glabela (entrecejo)','PGI'=>'Patas de gallo izq.',
        'PGD'=>'Patas de gallo der.','BL'=>'Bunny lines','L'=>'Labios / Peribucales',
        'MI'=>'Masetero izq.','MD'=>'Masetero der.','C'=>'Cuello',
      ];
    ...
    {{-- PUNTOS 11 Y 12 + FIRMAS juntos para evitar que queden solos --}}
